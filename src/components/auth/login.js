...
render() {
    ...
    return (
      <Grid>
        <Row>
          <Col xs={8} xsOffset={2} sm={4} smOffset={1} md={4} mdOffset={2} lg={3}>
            <Panel header={loginPanelHeader}>
              <form onSubmit={ handleSubmit(this.handleFormSubmit.bind(this)) }>
                <FormGroup>
                  <Field
          ...
          <Col xsOffset={2} smOffset={0} sm={6} md={6}>
            <Image className={'valign_img'} responsive src={`./images/Jason_silhouette.png`}/>
          </Col>
        </Row>
      </Grid>
    )
