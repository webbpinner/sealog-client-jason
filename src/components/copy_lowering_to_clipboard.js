...
class CopyLoweringToClipboard extends Component {
  ...
  copyToClipboard() {
    if(this.props.lowering && this.props.lowering.lowering_id) {
      ...
      text += (this.props.lowering.lowering_additional_meta.stats && this.props.lowering.lowering_additional_meta.stats.dive_origin) ? `Dive Origin:  ${this.props.lowering.lowering_additional_meta.stats.dive_origin.join(', ')}\n` : "";
